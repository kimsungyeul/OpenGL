...
void Widget::keyPressEvent(QKeyEvent *event)
{
    ...
    QString str = QString("(%1,%2,%3)" "(%1,%4,%5,%6,%7,%8)")
            .arg(xAngle).arg(yAngle).arg(zAngle).arg(left).arg(right).arg(bottom)
            .arg(top).arg(bNear).arg(bFar);
    setWindowTitle(str);
